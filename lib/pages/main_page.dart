...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path_0.cubicTo(
        size.width * 0.1546786,
        size.height * 0.1865714,
        size.width * 0.1792857,
        size.height * 0.0498286,
        size.width * 0.2791071,
        size.height * 0.0636000);
    path_0.cubicTo(
        size.width * 0.3653214,
        size.height * 0.0576000,
        size.width * 0.4341786,
        size.height * 0.1637143,
        size.width * 0.5598571,
        size.height * 0.2128571);
    path_0.cubicTo(
        size.width * 0.6088571,
        size.height * 0.2345143,
        size.width * 0.7381071,
        size.height * 0.2307429,
        size.width * 0.8281429,
        size.height * 0.2810286);
    path_0.cubicTo(
        size.width * 0.8962143,
        size.height * 0.3352571,
        size.width * 0.9222500,
        size.height * 0.3306857,
        size.width * 0.9295000,
        size.height * 0.3874857);
    path_0.cubicTo(
        size.width * 0.9291786,
        size.height * 0.4448571,
        size.width * 0.9630357,
        size.height * 0.5069143,
        size.width * 0.9183929,
        size.height * 0.6168571);
    path_0.cubicTo(
        size.width * 0.9012500,
        size.height * 0.7085143,
        size.width * 0.8998571,
        size.height * 0.7026857,
        size.width * 0.8679643,
        size.height * 0.7602286);
    path_0.cubicTo(
        size.width * 0.8180000,
        size.height * 0.8129143,
        size.width * 0.8405357,
        size.height * 0.9283429,
        size.width * 0.7224286,
        size.height * 0.9265143);
    path_0.cubicTo(
        size.width * 0.5850714,
        size.height * 0.9168571,
        size.width * 0.5231071,
        size.height * 0.7522286,
        size.width * 0.4358571,
        size.height * 0.7511429);
    path_0.cubicTo(
        size.width * 0.2115000,
        size.height * 0.7173714,
        size.width * 0.1015714,
        size.height * 0.7332571,
        size.width * 0.0624286,
        size.height * 0.5713714);
    path_0.cubicTo(
        size.width * 0.0319643,
        size.height * 0.4621143,
        size.width * -0.0238571,
        size.height * 0.3045143,
        size.width * 0.0605000,
        size.height * 0.2241714);
    path_0.close();
